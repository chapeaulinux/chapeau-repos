...
Obsoletes:      fedora-repos-anaconda < 20-1
Obsoletes:      fedora-repos-rawhide < 20-0.4
Obsoletes:      fedora-release-rawhide <= 20-0.7
BuildArch:      noarch

%description
Chapeau package repository files for yum along with gpg public keys
...
%changelog
* Sat Jan 03 2015 Vince Pooley 20-1
- New Chapeau repository package for Chapeau 20
